...
# using lamda func with methods sort and filter
users = [
    {"user_id": 21, "name": "Oleksandr", "age": 24},
    {"user_id": 42, "name": "Oleg", "age": 34},
    {"user_id": 33, "name": "Yuriy", "age": 35},
]
...
# users.sort(key=sort_by_id)  # using regular func
users.sort(key=lambda user: user["age"])  # using lamda
print(users)
